...
const NewArrivals = () => {
  ...
  return (
    ...
    <div className='bg-primary rounded-3xl py-1 sm:py-4 xl:py-12' >
      <div className='w-[90%] mx-auto'>
        <h3 className='h3 font-ace text-secondary mt-2 sm:mt-12'>Recent Arrivals</h3>
        <div className='grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 sm:mt-16'>
